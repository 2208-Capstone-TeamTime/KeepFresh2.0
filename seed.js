...
const receipt6 = new Receipts({
  _id: new mongoose.Types.ObjectId,
  transaction: 6,
  products: [apple._id, apple._id, cheese._id, hotDogs._id, beef._id, fish._id, eggs._id, shrimp._id, eggs._id, strawberry._id, cherry._id, lettuce._id, mushrooms._id, onions._id]
})
